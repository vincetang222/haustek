...
| `test/smoke.mjs` | 16 phép kiểm trên chính CRM |
...
```bash
node crm/test/smoke.mjs         # 16 phép kiểm trên CRM
...
`Date`, cả 12 tab, drawer/chi tiết/import, hiệu năng bảng ảo hoá, và không tràn
ngang ở khổ điện thoại.
