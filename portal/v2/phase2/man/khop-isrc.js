...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      chonDongMo: 'Mỗi dòng là một khoản tiền chưa có người thụ hưởng. Bấm để xem gợi ý bản ghi và lý do.',
      truyThu: 'Khoản truy thu',
      truyThuMo: 'Kỳ này đã xét duyệt và thanh toán. Khớp bây giờ không sửa kỳ cũ: tiền ghi vào kỳ đang mở, kèm ghi chú truy thu.',
      vaoKy: 'Sẽ ghi vào kỳ',
    ...
    en: {
      ...
      chonDongMo: 'Each row is money with no owner. Open one for the suggested recording and why.',
      truyThu: 'Back-claim',
      truyThuMo: 'This period is approved and paid. Matching now does not rewrite it: the money lands in the open period as a back-claim.',
