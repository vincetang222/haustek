...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      mo: 'Hồ sơ đối tác gửi lên để phát hành bản ghi mới: tiếp nhận, cấp mã ISRC/UPC, đẩy lên nền tảng. Bản ghi chỉ khớp được doanh thu khi đã có ISRC trong danh mục.',
      ...
      cMa: 'Mã hồ sơ', cTen: 'Bản phát hành', cLoai: 'Loại', cNgay: 'Ngày mong muốn', cGui: 'Gửi bởi', cTt: 'Trạng thái', cCapNhat: 'Cập nhật',
      khong: 'Không có hồ sơ nào', khongMo: 'Đổi bộ lọc, hoặc chờ đối tác gửi hồ sơ mới.',
      tiepNhan: 'Tiếp nhận', capMa: 'Cấp mã ISRC/UPC', danhDau: 'Đánh dấu đã phát hành', traLaiNut: 'Trả lại để bổ sung',
      ...
      hoiMa: 'Cấp mã cho hồ sơ này?', hoiMaMo: 'Track chưa có ISRC sẽ được cấp mã VN-HTK; bản phát hành chưa có UPC sẽ được cấp UPC. Mã đã cấp không đổi được.',
      hoiTiep: 'Tiếp nhận hồ sơ này?', hoiTiepMo: 'Tiếp nhận nghĩa là đã kiểm tra hồ sơ đủ thông tin để đi tiếp. Đối tác sẽ thấy trạng thái đổi ngay.',
      ...
      quyTrinhMo: 'Bản ghi có ISRC nằm trong danh mục thì báo cáo doanh thu về sẽ tự khớp theo mã. Bản ghi phát hành mà không có mã trong danh mục là bản ghi chắc chắn rơi vào danh sách chờ khớp ISRC.',
      guiBoi: 'Gửi bởi', ngayGui: 'Gửi lúc', ngayMong: 'Ngày phát hành mong muốn', ngayThuc: 'Ngày phát hành thực tế',
