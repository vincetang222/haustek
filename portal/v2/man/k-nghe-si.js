...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      cNs: 'Nghệ sĩ', cBai: 'Bài hát có doanh thu', cLuot: 'Lượt nghe', cGop: 'Doanh thu gộp',
      cNsHuong: 'Phần nghệ sĩ', cLabel: 'Phần label', cTyLe: 'Tỷ lệ',
      topNs: 'Nghệ sĩ mang về doanh thu nhiều nhất kỳ này', topNsMo: 'Theo doanh thu gộp. Bấm một dòng trong bảng để xem chi tiết.',
