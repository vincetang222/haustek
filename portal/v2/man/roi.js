...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      ss2: 'ROI ở trang Xét duyệt', ss2v: 'Phần Haustek giữ trong thời gian thu hồi, chia cho khoản ứng. Dùng cho tạm ứng trên tài khoản đã chạy.',
    ...
    en: {
      ...
      ss2: 'ROI in Approvals', ss2v: 'What Haustek keeps during recoupment, divided by the advance. For an advance on an account already running.',
