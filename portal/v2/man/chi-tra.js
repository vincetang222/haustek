...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      nguong: 'Ngưỡng thanh toán tối thiểu', nguongMo: 'Khoản dưới ngưỡng không mất: chuyển sang kỳ sau và cộng vào lần thanh toán đó. Ngưỡng có vì phí chuyển khoản quốc tế.',
      ...
      hoiTaoHo: 'Tạo yêu cầu rút tiền hộ đối tác', hoiTaoHoMo: 'Dùng khi đối tác gọi điện hoặc email. Số tiền từ ngưỡng tối thiểu đến số dư khả dụng; đối tác đã khai ngân hàng.',
      ...
      bkMo: 'Mỗi bên thụ hưởng của kỳ đã xét duyệt có một bảng kê PDF do Haustek lập; đối tác tải ở trang Bảng kê.',
    ...
    en: {
      ...
      nguong: 'Payout threshold', nguongMo: 'Below the threshold nothing is lost: it carries to the next period. The threshold exists because of transfer fees.',
      ...
      hoiTaoHo: 'Log a withdrawal for a partner', hoiTaoHoMo: 'For partners who phone or email. Amount between the minimum and the balance; bank account on file.',
      ...
      bkMo: 'Every payee of an approved period gets a PDF statement from Haustek; partners download it on their Statement page.',
