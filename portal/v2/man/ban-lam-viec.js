...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      dxNoiDung: 'Nội dung', dxThaoTac: 'Thao tác', dxRoi: 'Phần giữ ÷ khoản ứng', dxThuHoi: 'thu hồi {n} tháng', dxTuDoiTac: 'từ cổng đối tác',
    ...
    en: {
      ...
      dxNoiDung: 'Terms', dxThaoTac: 'Actions', dxRoi: 'Share ÷ advance', dxThuHoi: 'recoup {n} mo', dxTuDoiTac: 'from the partner portal',
