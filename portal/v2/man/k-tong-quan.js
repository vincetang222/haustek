...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      nhipTq1: 'Tổ chức tác quyền (VCPMC, The MLC, ASCAP, PRS, GEMA…) chốt sổ theo <b>quý</b>, không theo tháng.',
      nhipTq2: 'Họ báo cáo <b>trễ một đến hai quý</b>, nên tác quyền của bài nghe hôm nay thường nửa năm sau mới có.',
      nhipTq3: 'Vì vậy phần lớn kỳ <b>không có báo cáo tác quyền</b>. Bình thường, không phải bài không có doanh thu.',
    ...
    en: {
      ...
      nhipTq1: 'Collecting societies (VCPMC, The MLC, ASCAP, PRS, GEMA…) settle <b>quarterly</b>, not monthly.',
      nhipTq2: 'They report <b>one to two quarters late</b>, so publishing on a play today usually arrives about six months later.',
      nhipTq3: 'So most periods have <b>no publishing report</b>. Normal, not a sign your works earned nothing.',
