...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      danhMuc: 'Bản phát hành trong danh mục', danhMucMo: 'Suy ra từ bản ghi đang phân phối. Bản có doanh thu ở kỳ đã xét duyệt được đánh dấu.',
      cMa: 'Mã hồ sơ', cTen: 'Bản phát hành', cLoai: 'Loại', cNgay: 'Ngày mong muốn', cTt: 'Trạng thái', cCapNhat: 'Cập nhật',
      cKy: 'Kỳ phát hành', cTrack: 'Track', cDt: 'Doanh thu gộp các kỳ đã xét duyệt', coDt: 'đã có', chuaDt: 'chưa có',
      khongHs: 'Chưa gửi hồ sơ nào', khongHsMo: 'Hồ sơ gửi từ biểu mẫu metadata ở trang chủ hoặc từ nút phía trên sẽ hiện ở đây.',
      quyTrinh: 'Hồ sơ đi qua những bước nào',
      b1: 'Đã gửi', b1m: 'Hồ sơ vào hàng chờ của Haustek. Chưa cần làm gì thêm.',
      b2: 'Đã tiếp nhận', b2m: 'Haustek đã kiểm tra đủ thông tin. Nếu thiếu, hồ sơ được trả lại kèm ghi chú cần bổ sung.',
      b3: 'Đã cấp mã', b3m: 'Track được cấp ISRC, bản phát hành được cấp UPC. Đây là mã dùng để khớp doanh thu về sau.',
      b4: 'Đã phát hành', b4m: 'Bản ghi đã lên nền tảng. Doanh thu về từ kỳ sau đó và hiện trong Bài hát của bạn.',
      ...
      formBia: 'Link ảnh bìa', formGhi: 'Ghi chú cho đội phát hành', formTracks: 'Danh sách track',
      themTrack: 'Thêm track', xoaTrack: 'Bỏ track', trTen: 'Tên track', trFeat: 'Khách mời (feat.)', trIsrc: 'ISRC (nếu đã có)',
      trProducer: 'Producer', trSangTac: 'Sáng tác và tỉ lệ', themNguoi: 'Thêm người', tenThat: 'Họ tên thật', vaiTro: 'Vai trò', tiLe: 'Tỉ lệ %',
      formMo: 'Đây là bản rút gọn của biểu mẫu metadata trên trang chủ, đúng các trường bắt buộc. Hồ sơ gửi xong không sửa được; cần sửa thì Haustek trả lại để bạn gửi lại.',
      daGui: 'Đã gửi hồ sơ', formDay: 'Biểu mẫu đầy đủ trên trang chủ',
      tongTiLe: 'Tổng tỉ lệ sáng tác phải bằng 100%'
    },
    en: {
