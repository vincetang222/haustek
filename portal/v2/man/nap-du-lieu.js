...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      mo: 'Ba nguồn báo cáo bản ghi và một dòng tác quyền theo quý. Thiếu nguồn thì kỳ chưa thể xét duyệt.',
      ...
      hoiGoMo: 'Gỡ báo cáo rút toàn bộ doanh thu nguồn đó khỏi tổng kỳ. Dòng đã khớp tay vẫn còn nhưng chưa tính tới khi nhập lại.',
    ...
    en: {
      ...
      mo: 'Three recording feeds plus a quarterly publishing stream. A missing feed blocks approval.',
      ...
      hoiGoMo: 'Unloading removes that feed’s money from the period total. Hand-matched rows stay but do not count until reloaded.',
