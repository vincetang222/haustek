...
HT.dangKy({
  ...
  chu: {
    vi: {
      ...
      canhQuyen: 'Quyền gắn với mã số, không gắn với tên hiển thị: sai một ký tự tên là nghệ sĩ mất tiền hoặc thấy dữ liệu người khác.',
      ...
      ghiQ9: 'Label mẹ được uỷ quyền xem toàn bộ số của label con; không có dòng tiền qua label mẹ (câu hỏi số 9).',
      ...
      dlCanh: 'Xoá toàn bộ sẽ mất mọi quyết định trong bản mẫu: kỳ đã duyệt, dòng đã khớp, tỷ lệ, tạm ứng, tài khoản. Danh mục và doanh thu sinh lại y hệt.',
    ...
    en: {
      ...
      canhQuyen: 'Access binds to the ID, never the display name: one wrong character and an artist loses money or sees someone else’s data.',
      ...
      ghiQ9: 'A parent label may see everything about its sub-labels; no money flows through it (question 9).',
      ...
      dlCanh: 'Wiping drops every decision: approved periods, matched rows, rates, advances, accounts. Catalogue and revenue regenerate identically.',
