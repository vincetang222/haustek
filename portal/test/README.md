...
| `tien-dung-so.js` | Vòng 23. qc-bat-bien kiểm tiền có CÂN không; bài này kiểm tiền có nói ĐÚNG SỐ không. Bốn lỗi đo được: chỉ mục người viết nạp một bài hai lần khi một người đứng cả hai vai tác giả (12 nghệ sĩ, cổng thấy thừa 7,40 USD một kỳ); bảng giải thích đọc sai tên trường nên dòng dồn kỳ hiện rỗng; trang Chia sẻ báo 38.132,54 USD "đã trả" trong khi tiền thật đổi chủ là 44,14 USD; tạm ứng kẹp số dư về 0 làm mất dấu phần đã thu hồi. Thêm ba phép cho vòng 23c: nghệ sĩ độc lập VẪN đóng phí hợp đồng, đối soát cân gộp = phí + trả đối tác, và cổng của họ sạch mọi trường phí. |
...
| `cua-dang-nhap.js` | Vòng 25. Bài kiểm **duy nhất cố ý không gieo sẵn phiên** — nó kiểm chính cái cửa. 22 phép trên cả hai cổng: chưa đăng nhập thì thấy cửa chứ không thấy cổng; ô mật khẩu có mặt và tự khai bản mẫu không kiểm; email lạ bị chặn và câu lỗi KHÔNG tiết lộ email có tồn tại hay tài khoản bị khoá; bấm tài khoản mẫu thì điền email; vào được thì cửa **gỡ hẳn khỏi DOM** (đã có lúc nó nằm đè 720px phía trên cổng); nạp lại vẫn ở trong; đăng xuất rồi nạp lại vẫn ở cửa; hai email sai khác nhau thành hai dòng nhật ký chứ không gộp; không dòng nào mang địa chỉ IP. |
...
| `v2-khach-tk.js` | Lặp qua cả 11 tài khoản mẫu. Label không có tab tác quyền, nghệ sĩ độc lập nhận trọn phần sau phí, nghệ sĩ thuộc label tự trả thấy ghi "label trả", người đang nợ tạm ứng có màn riêng — quét một tài khoản là quét đúng một trong số đó. |
| `v2-luong.js` | Chuỗi vận hành đầu-cuối, bấm bằng chuột, hai người: kế toán ghi nhận chênh lệch (giám đốc không có nút này — vòng 22) → giám đốc chốt tỷ giá kỳ → duyệt kỳ → khách nhìn thấy → sổ kế toán cân → thu hồi → mọi thứ trả về. |
...
node test/cua-dang-nhap.js     # cần server tĩnh; bài này KHÔNG gieo phiên
